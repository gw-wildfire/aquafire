...
library(tmap)
color_palette <- pal_nlcd()

tm_raster <- tm_raster(nlcd_rasterlayer, palette = color_palette)
# Add a legend to the plot

tm_raster_legend <- tm_legend(show = TRUE, legend.format = list(
  text.separator = " - ",
  text.align = c("left", "left"),
  text.valign = c("bottom", "bottom"),
  text.size = 1.2,
  text.fontface = "plain",
  text.color = "black",
  title = "Legend Title"
